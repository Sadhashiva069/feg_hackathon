...
// Compares every file under empireofgold/ with tests/bundle-hashes.json (SHA-256 recorded from the
...
const DIR = path.resolve(process.argv[2] || path.join(ROOT, 'empireofgold'));
